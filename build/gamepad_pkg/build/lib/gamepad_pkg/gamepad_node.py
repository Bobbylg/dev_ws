...
class ControllerPublisher(Node):
    ...
    def joystick_callback(self):
        ...
        linear_velocity_Y = -linear_axis_Y *  6.0  # Adjust scale as needed
        linear_velocity_X = linear_axis_X *   6.0  # Adjust scale as needed
        angular_velocity_Z = angular_axis_Z * 6.0
